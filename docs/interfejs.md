...
Wyświetla numer bieżącej rundy i pytania oraz nazwę aktualnej kategorii (po jej wylosowaniu). Po prawej stronie znajduje się przycisk **Cofnij**, który przywraca poprzedni stan gry.
...
Aplikacja zapisuje historię do 50 ostatnich stanów gry. Kliknięcie przycisku Cofnij w pasku górnym przywraca stan sprzed ostatniej akcji. Pozwala to na korektę pomyłek prowadzącego. Historia stanów przechowywana jest w pliku `data/game_history.json` i przetrwa restart serwera.
